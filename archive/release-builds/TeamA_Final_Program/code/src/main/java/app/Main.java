 ...
 *
 * <p>This class is kept for prototype traceability and scripted regression
 * testing. The final graphical presentation uses {@link FinalGuiMain}, while
 * the same domain classes continue to execute the actual game rules.</p>
 */
public class Main {
